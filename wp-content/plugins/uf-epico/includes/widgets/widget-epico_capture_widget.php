...
class Widget_Epico_Capture extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'epico_capture_widget-id', __( 'Épico Capture', 'uf-epico' ), array( 'description' => __( 'Custom e-mail opt-in forms.', 'uf-epico' ) ), array( 'width' => 495 ) );
	...
	public function form( $instance ) {
		...
		if ( file_exists( self::get_path( dirname( __DIR__ ) ) . 'configs/fieldgroups-epico_capture_widget.php' ) ) {
			include self::get_path( dirname( __DIR__ ) ) . 'configs/fieldgroups-epico_capture_widget.php';
		} else {
			return;
		}
