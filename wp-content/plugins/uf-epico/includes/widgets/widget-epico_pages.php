...
class Widget_Epico_Pages extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'epico_pages-id', __( 'Épico Pages', 'uf-epico' ), array( 'description' => __( 'Create beautiful links for your special pages.', 'uf-epico' ) ), array( 'width' => 495 ) );
	...
	public function form( $instance ) {
		...
		if ( file_exists( self::get_path( dirname( __DIR__ ) ) . 'configs/fieldgroups-epico_pages.php' ) ) {
			include self::get_path( dirname( __DIR__ ) ) . 'configs/fieldgroups-epico_pages.php';
		} else {
			return;
		}
