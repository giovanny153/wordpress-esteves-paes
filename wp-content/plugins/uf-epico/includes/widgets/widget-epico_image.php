...
class Widget_Epico_Image extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'epico_image-id', __( 'Épico Image', 'uf-epico' ), array( 'description' => __( 'Add images to your widget areas.', 'uf-epico' ) ) );
	...
	public function form( $instance ) {
		...
		if ( file_exists( self::get_path( dirname( __DIR__ ) ) . 'configs/fieldgroups-epico_image.php' ) ) {
			include self::get_path( dirname( __DIR__ ) ) . 'configs/fieldgroups-epico_image.php';
		} else {
			return;
		}
