...
class Widget_Epico_Pop extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'epico_pop-id', __( 'Épico Pop', 'uf-epico' ), array( 'description' => __( 'Popular posts widget.', 'uf-epico' ) ), array( 'width' => 495 ) );
	...
	public function form( $instance ) {
		...
		if ( file_exists( self::get_path( dirname( __DIR__ ) ) . 'configs/fieldgroups-epico_pop.php' ) ) {
			include self::get_path( dirname( __DIR__ ) ) . 'configs/fieldgroups-epico_pop.php';
		} else {
			return;
		}
