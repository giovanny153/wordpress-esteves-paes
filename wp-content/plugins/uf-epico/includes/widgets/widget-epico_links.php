...
class Widget_Epico_Links extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'epico_links-id', __( 'Épico Links', 'uf-epico' ), array( 'description' => __( 'Create beautiful links for your blog.', 'uf-epico' ) ), array( 'width' => 495 ) );
	...
	public function form( $instance ) {
		...
		if ( file_exists( self::get_path( dirname( __DIR__ ) ) . 'configs/fieldgroups-epico_links.php' ) ) {
			include self::get_path( dirname( __DIR__ ) ) . 'configs/fieldgroups-epico_links.php';
		} else {
			return;
		}
	...
	public function register_admin_styles_scripts() {
		...
		wp_enqueue_style( 'uf-epico-panel-styles', self::get_url( 'assets/css/panel-min.css', dirname( __FILE__ ) ) );
