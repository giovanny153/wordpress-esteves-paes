...
class Widget_Epico_Author extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'epico_author-id', __( 'Épico Author', 'uf-epico' ), array( 'description' => __( 'Custom author box widget.', 'uf-epico' ) ), array( 'width' => 495 ) );
	...
	public function form( $instance ) {
		...
		if ( file_exists( self::get_path( dirname( __DIR__ ) ) . 'configs/fieldgroups-epico_author.php' ) ) {
			include self::get_path( dirname( __DIR__ ) ) . 'configs/fieldgroups-epico_author.php';
		} else {
			return;
		}
