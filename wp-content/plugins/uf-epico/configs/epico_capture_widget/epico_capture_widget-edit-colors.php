...
$group = array(
	...
	'fields'   => array(
		...
		'email_color' => array(
			'label'   => esc_attr__( 'Field\'s background color', 'uf-epico' ),
			'caption' => esc_attr__( 'Choose a background color for the fields.', 'uf-epico' ),
			'type'    => 'colorpicker',
			'default' => '#FFFFFF',
		),
		'email_text_color' => array(
			'label'   => esc_attr__( 'Field\'s text color', 'uf-epico' ),
			'caption' => esc_attr__( 'Choose a color for the field\'s text.', 'uf-epico' ),
			'type'    => 'colorpicker',
			'default' => '#687E87',
		),
		'email_placeholder_color' => array(
			'label'   => esc_attr__( 'Field\'s placeholder color', 'uf-epico' ),
