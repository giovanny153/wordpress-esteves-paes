...
/**
*
* Arquivo de configuração: Email marketing (Épico Capture)
*
* @package   Uf_Epico
...
$group = array(
	...
	'fields' => array(
		...
		'webform_id_alt' =>	array(   // campo 12
			...
			'caption'	=> esc_attr__( 'Unique ID of your form.','uf-epico'),
			'type'		=> 'textfield',
			'default'	=> '',
		),
		'tracking_code'	=> array(   // campo 13
			'label'		=> esc_attr__( 'Tracking code','uf-epico'),
			'caption'	=> esc_attr__( 'Tracking code.','uf-epico'),
			'type'		=> 'textfield',
			'default'	=> '',
		),
		'campaign_id'	=> array(   // campo 14
			'label'		=> esc_attr__( 'Campaign ID','uf-epico'),
			'caption'	=> esc_attr__( 'ID of your campaign.','uf-epico'),
			'type'		=> 'textfield',
			'default'	=> '',
		),
		'instructions'	=> array(   // campo 15
			'label'		=> esc_attr__( 'Mailster Instructions','uf-epico'),
			'caption'	=> esc_attr__( 'Please also configure your Mailster plugin in "Newsletter > Settings in your WordPress.','uf-epico'),
			'type'		=> 'paragraph',
			'default'	=> '',
		),
		...
		'name_field_id'  => array(   // campo 22
			...
			'caption'	=> esc_attr__( 'Name field ID.','uf-epico'),
			'type'		=> 'smalltextfield',
			'default'	=> '',
		),
		...
		'redirect_error_url'	=> array(   // campo 24
			...
			'caption'	=> esc_attr__( 'Custom redirect URL for subscription error.','uf-epico'),
			'type'		=> 'textfield',
			'default'	=> '',
		),
		'gdpr_field_id'	=> array(   // campo 25
			'label'		=> esc_attr__( 'GDPR field ID','uf-epico'),
			'caption'	=> esc_attr__( 'ID for the GDPR field.','uf-epico'),
			'type'		=> 'textfield',
			'default'	=> '',
		),
	),
