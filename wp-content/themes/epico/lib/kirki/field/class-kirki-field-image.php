...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'epico' ),
				'change'       => esc_html__( 'Change image', 'epico' ),
				'default'      => esc_html__( 'Default', 'epico' ),
				'remove'       => esc_html__( 'Remove', 'epico' ),
				'placeholder'  => esc_html__( 'No image selected', 'epico' ),
				'frame_title'  => esc_html__( 'Select image', 'epico' ),
				'frame_button' => esc_html__( 'Choose image', 'epico' ),
			)
		);
	}
