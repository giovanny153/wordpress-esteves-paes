<?php
/**
 * Template Name: Página de aterrisagem
 *
 * @package Épico
 * @since   1.0.2
 */
	...
	<div id="page">
		...
		<header <?php hybrid_attr( 'header' ); ?>>
				...
				<div class="wrap">
					...
					<div id="branding" itemscope itemtype="https://schema.org/Organization">
					...
					<?php } else { ?>
						...
						<p itemscope itemtype="https://schema.org/Organization"  id="site-title" itemprop="name">
