...
<?php get_header(); // Carrega o template header.php. ?>
	...
	<div id="main-container">
		...
		elseif ( $site_layout == 1 ) :
			...
			<main id="content" class="content <?php echo esc_html( $content_class ); ?>" role="main" itemscope itemtype="https://schema.org/Blog">
				...
				<?php if ( ! is_home() && ! is_front_page() && ! is_singular() && ! is_404() ) : // Se NAO estiver na pagina inicial, em um post unico ou na pagina 404 ?>
